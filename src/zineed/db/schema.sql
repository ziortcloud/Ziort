-- ZiNeed Database Schema
-- Product: ZND | All tables scoped by entity_id + subscription_id

-- ─────────────────────────────────────────────
-- ZND Requirements (REQ prefix → REQ26A01)
-- ─────────────────────────────────────────────
CREATE TABLE IF NOT EXISTS znd_requirements (
  ...
  status            TEXT NOT NULL DEFAULT 'published'
                      CHECK (status IN ('draft','published','matching','proposals_received',
...
-- ─────────────────────────────────────────────
-- ZND Proposals (PRO prefix → PRO26A01)
-- ─────────────────────────────────────────────
...
-- Prevent duplicate proposals from same entity on same requirement
...
-- ─────────────────────────────────────────────
-- ZND Ratings (RTG prefix → RTG26A01)
-- ─────────────────────────────────────────────
...
-- Proposal count maintenance trigger
